...
#        np.savez("data4", t4_d1=d1, t4_d2=d2)
    ...
    def test_6_generate_tone(self):
        ...
        print(str.format('{0:.10f}', mid_c[80]))
        print(str.format('{0:.10f}', Tests.data["t6_midc"][80]))
        print(str.format('{0:.10f}', mid_c[5]))
        print(str.format('{0:.10f}', Tests.data["t6_midc"][5]))
        print(str.format('{0:.10f}', mid_c[70]))
        print(str.format('{0:.10f}', Tests.data["t6_midc"][70]))
        print(mid_c[0:10])
        print(Tests.data["t6_midc"][0:10])
        print(np.isclose(mid_c, Tests.data["t6_midc"]))
